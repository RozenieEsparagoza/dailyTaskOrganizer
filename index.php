...
<html lang="en">
  <head>
    ...
    <title>Daily Task Organizer</title>
  ...
  <div class="container vh-100 mb-5">
    ...
    <h1 class="text-center py-4 my-4">Daily Task Organizer </h1>

    <div class="w-50 m-auto">
    <form action="add.php" method="post" autocomplete="off">
        <div class="form-group">
            <label for="title"><center>Daily Task Organizer</center></label>
            <input class="form-control" type="text" name="title" id="title" placeholder="Type Here" Required>

        </div><br>
        <center><button class="btn btn-success">Add Task</button></center>
    </form>

    </div><br>
    <hr class="bg-dark w-50 m-auto">
    <div class="lists w-50 m-auto my-4">
        <center><h1>Your Task</h1></center>
        <div id="lists">
        <table class=" table table-hover" style="background-color: aqua">
  <thead>
    <tr>
      <th scope="col" name="id">#</th>
      <th scope="col">Daily Task Organizer</th>
    <th>Action</th>
    </tr>
  </thead>
  <tbody>
